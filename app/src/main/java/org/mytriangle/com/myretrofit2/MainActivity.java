...
public class MainActivity extends AppCompatActivity {
    ...
    private void getPeopleDetails() {
        ...
        try {
            Retrofit retrofit = new Retrofit.Builder()
                    .baseUrl("http://ventanaesperanza.webcindario.com/apis/").
          ...
          GETAPIService service = retrofit.create(GETAPIService.class);
            ...
            call.enqueue(new Callback<List<People>>() {
                ...
                public void onResponse(Response<List<People>> response, Retrofit retrofit) {
                    ...
                    Log.d("Log",String.valueOf(peopleData));
                    String details = "";
                    if (peopleData==null)
                    {
                        ...
                        for (int i = 0; i < peopleData.size(); i++) {
                            ...
                            String name = peopleData.get(i).getPuercos();
    ...
    /*private void setPeopleDetails() {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("http://10.10.42.9:8080/apis").
                        addConverterFactory(GsonConverterFactory.create())
                .build();
